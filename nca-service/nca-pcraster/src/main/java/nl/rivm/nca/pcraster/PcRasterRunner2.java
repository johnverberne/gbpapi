...
class PcRasterRunner2 {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(PcRasterRunner2.class);
	...
	public void runPcRaster(String correlationId, String ecoSystemService, File projectFileScenario, File projectFileBaseLine, File workingPathScenario, File workingFileBaseLine, File projectFileDiff )
