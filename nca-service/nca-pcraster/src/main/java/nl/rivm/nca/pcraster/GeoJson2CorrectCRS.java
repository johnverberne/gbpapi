...
public class GeoJson2CorrectCRS {
  ...
  public static void geoJsonConvert(File geoJsonInput, java.util.logging.Logger jobLogger) throws IOException {
    final String[] args = {"-s_srs", "EPSG:4326", "-t_srs", "EPSG:28992", "-f", "GEOJSON", geoJsonInput.getAbsolutePath(),
