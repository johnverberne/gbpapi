 ...
 * ae_create_hexagon
 * -----------------
 * Functie berekent en retouneert een hexagon voor het opgegeven receptor_id en zoom_level.
 */
...
BEGIN
	...
	-- Initialise
	surface_zoom_level_1	= ae_constant('SURFACE_ZOOM_LEVEL_1')::integer;
	...
	-- Scale the hexagon and indicate it as Rijksdriehoekstelsel
