...
docker run --rm -v /tmp:/tmp -v $NKM_HOME:/opt/NatuurlijkKapitaalModellen -v $NCM_WORKSPACE:/opt/nkmodel nca-docker python /opt/NatuurlijkKapitaalModellen/source/script/$1.py $2
