...
/*
 * user_request_download_permissions
 * ---------------------------------
 * Tabel met daarin per gebruiker de aanvragen (AERIUS kenmerken) waartoe de gebruiker toegang heeft.
 *
 * @column request_reference het AERIUS kenmerk van de aanvraag (gelijk aan requests.reference).
 */
CREATE TABLE user_request_download_permissions (
	user_id integer NOT NULL,
	request_reference text NOT NULL,

	CONSTRAINT user_request_download_permissions_pkey PRIMARY KEY (user_id, request_reference)
);
 ...
 *
 * @column hexagon_counter Aantal hectares dat reeds is doorgerekend
...
CREATE TABLE job_progress (
	job_id integer NOT NULL,
	hexagon_counter bigint NOT NULL DEFAULT 0,
