...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('MELDING_NOT_REGISTERED_AUTHORITY_MAIL_SUBJECT', 'nl', '[AUTHORITY] Meldingsbericht niet geregisteerd, kenmerk [AERIUS_REFERENCE] bedrijfsnaam [PROJECT_NAME]');
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('MELDING_DOES_NOT_FIT', 'nl', 'de melding van uw initiatief is niet geregistreerd, omdat de projectbijdrage van uw initiatief groter is dan de beschikbare depositieruimte.');
...
-- Splash
INSERT INTO i18n.messages (key, language_code, message) VALUES ('SPLASH_ATTRIBUTION_TEXT', 'nl', 'AERIUS is ontwikkeld in opdracht van de Rijksoverheid en de gezamelijke provincies.');
