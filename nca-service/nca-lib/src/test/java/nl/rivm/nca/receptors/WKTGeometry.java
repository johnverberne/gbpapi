 ...
 */
public class WKTGeometry extends Geometry implements Serializable, HasState {

  private static final long serialVersionUID = -2858652736679920246L;
  ...
  public int getStateHash() {
    ...
    final long temp = Double.doubleToLongBits(measure);
