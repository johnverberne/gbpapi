-- email constants
INSERT INTO i18n.messages (key, language_code, message) VALUES ('PASSWORD_RESET_REQUEST_SUBJECT', 'en', 'AERIUS - Password reset request');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('PASSWORD_RESET_REQUEST_BODY', 'en', '<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p><p style="font-family:Arial;font-size:14px;">Via the website we have been notified that you lost your password.</p><p style="font-family:Arial;font-size:14px;">Click on the following link to reset your password, you will recieve an email with your new password.</p><p style="font-family:Arial;font-size:14px;">[PASSWORD_RESET_URL]</p>');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('PASSWORD_RESET_CONFIRM_SUBJECT', 'en', 'AERIUS - Password reset confirmation');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('PASSWORD_RESET_CONFIRM_BODY', 'en', '<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p><p style="font-family:Arial;font-size:14px;">Your password has been reset.</p><p style="font-family:Arial;font-size:14px;">Your new password is: <b>[PASSWORD_RESET_PLAIN_TEXT_NEW]</b></p>');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('CONNECT_APIKEY_CONFIRM_SUBJECT', 'en', 'Your AERIUS Connect API key');
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('ERROR_MAIL_SUBJECT', 'en', 'Notification regarding you AERIUS file');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('ERROR_MAIL_CONTENT', 'en',
E'<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p>
<p style="font-family:Arial;font-size:14px;">At [CALC_CREATION_DATE] [CALC_CREATION_TIME] a AERIUS calculation has been started. Unfortunately this calculation cannot be completed.</p>
...
<p style="font-family:Arial;font-size:14px;">This error message has also automatically been sent to the AERIUS application manager.</p>
<p style="font-family:Arial;font-size:14px;">If you have any questions regarding this message, please first read <a href="#">frequently asked questions</a> about calculations. You can also contact the <a href="http://pas.bij12.nl/content/helpdesk">helpdesk</a>.
</p>');
...
E'<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p>
<p style="font-family:Arial;font-size:14px;">At [CALC_CREATION_DATE] [CALC_CREATION_TIME] You have requested an export in AERIUS. This export is ready and available till 3 days after the export has been generated.</p>
...
<p style="font-family:Arial;font-size:14px;">If you have any questions regarding the information provided in the export, please review our <a href="http://www.aerius.nl/nl/manuals/monitor">manual</a> or our webiste <a href="http://www.aerius.nl">AERIUS.nl</a>. You can also contact our helpdesk: <a href="http://pas.bij12.nl/content/helpdesk">pas.bij12.nl/content/helpdesk</a>.</p>');
...
E'<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p>
<p style="font-family:Arial;font-size:14px;">At [CALC_CREATION_DATE] [CALC_CREATION_TIME] you have started an AERIUS calculation. This task has been finished and the result can be downloaded till 3 days after this message.</p>
<div style="text-align:center"><a href="[DOWNLOAD_LINK]" style="display:inline-block;font-family:Arial;font-size:14px;background:linear-gradient(#DBE1E1, #B8C6C5) repeat scroll 0 0 transparent;width:auto;padding:10px 40px 0px;border:1px solid #4c4c4c; -moz-border-radius: 2px;border-radius:2px;box-shadow: 0 1px 0 #FFFFFF inset;color: #333333;height: 33px;text-align: center;text-shadow: 0 1px 0 white;text-decoration:none;font-weight:bold">Download file</a></div>
<p style="font-family:Arial;font-size:14px;">AERIUS Calculator can be used to calculate nitrogen effects of projects and spatial planning. For the actual applicability please visit <a href="https://www.aerius.nl/nl/over-aerius/producten/calculator">toepassingsbereik</a>.</p>
<p style="font-family:Arial;font-size:14px;">You can import the PDF and continue working with AERIUS.</p>
<p style="font-family:Arial;font-size:14px;">If you have any questions regarding this message, please first read the <a href="http://www.aerius.nl/nl/manuals/calculator">manual</a> or look at our website <a href="http://www.aerius.nl">AERIUS.nl</a>. You can also contact the <a href="http://pas.bij12.nl/content/helpdesk">helpdesk</a>.</p>');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('PAA_OWN_USE_MAIL_SUBJECT', 'en', 'Your AERIUS calculation for private use: [PROJECT_NAME]');
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('GML_MAIL_SUBJECT', 'en', 'Your AERIUS file [AERIUS_REFERENCE]');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('GML_MAIL_SUBJECT_JOB', 'en', 'Your AERIUS calculation [JOB] ([AERIUS_REFERENCE])');
INSERT INTO i18n.messages (key, language_code, message) VALUES ('GML_MAIL_CONTENT', 'en',
E'<p style="font-family:Arial;font-size:14px;">Dear Sir/Madam,</p>
<p style="font-family:Arial;font-size:14px;">At [CALC_CREATION_DATE] [CALC_CREATION_TIME] you have started an AERIUS calculation. The calculation has been finished and you will be able to download the GML result file, till 3 days after this message.</p>
<div style="text-align:center"><a href="[DOWNLOAD_LINK]" style="display:inline-block;font-family:Arial;font-size:14px;background:linear-gradient(#DBE1E1, #B8C6C5) repeat scroll 0 0 transparent;width:auto;padding:10px 40px 0px;border:1px solid #4c4c4c; -moz-border-radius: 2px;border-radius:2px;box-shadow: 0 1px 0 #FFFFFF inset;color: #333333;height: 33px;text-align: center;text-shadow: 0 1px 0 white;text-decoration:none;font-weight:bold">Download file</a></div>
<p style="font-family:Arial;font-size:14px;">You can use the GML-fileformat to exchange (geo)information about emission sources and calculation results between AERIUS and other (geo)data systems. This file can also be used to store your own work on a local drive.</p>
<p style="font-family:Arial;font-size:14px;">If you have any questions regarding this message, please first read the <a href="http://www.aerius.nl/nl/manuals/calculator">manual</a> or look at our website <a href="http://www.aerius.nl">AERIUS.nl</a>. You can also contact the <a href="http://pas.bij12.nl/content/helpdesk">helpdesk</a>.</p>');
...
<p style="font-family:Arial;font-size:14px;">Your pronouncement has been registered.</p>
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('MELDING_NOT_REGISTERED_TECHNICAL_ISSUE_USER_MAIL_SUBJECT', 'en','Ingediende melding niet geregistreerd door technische problemen');
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('MELDING_NOT_REGISTERED_AUTHORITY_MAIL_SUBJECT', 'en', '[AUTHORITY] Meldingsbericht niet geregistreed, kenmerk [AERIUS_REFERENCE] bedrijfsnaam [PROJECT_NAME]');
...
INSERT INTO i18n.messages (key, language_code, message) VALUES ('MELDING_ABOVE_PERMIT_THRESHOLD', 'en', 'the threshold value has been set to 0.71 grams/ha/y. Therefore you should request a permit.');    
...
-- Splash
INSERT INTO i18n.messages (key, language_code, message) VALUES ('SPLASH_ATTRIBUTION_TEXT', 'en', 'Development of AERIUS is commissioned by the Dutch government.<br />This evaluation version is built in collaboration with JNCC and Natural England.');
