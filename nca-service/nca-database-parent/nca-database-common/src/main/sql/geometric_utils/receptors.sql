 ...
 * -----------------------------------
 * Functie voor het bepalen het aantal hexagonen in een horizontale rij.
 */
...
DECLARE
	...
	surface_zoom_level_1 int = ae_constant('SURFACE_ZOOM_LEVEL_1')::integer;
 ...
 * -----------------------------------------
 * Functie voor het bepalen van een receptor_id bij gegeven x, y coordinaten en zoomlevel.
 * LET OP! Deze functie bevat een bug en werkt alleen voor zoomlevel 1.
 */
 ...
 * --------------------------------------
 * Functie voor het bepalen van de receptor_ids bij een gegeven rechthoek (bijvoorbeeld een background).
 */
 ...
 * -------------------------------------
 * Functie voor het bepalen van de receptor_ids in een gegeven geometrie.
 * Het doet dit door eerst alle receptoren in de boundingbox te bepalen, en dan voor iedere receptorpunt nader te bepalen of deze binnen de geometrie valt.
 */
 ...
 * ---------------------------------------------------
 * Functie voor het bepalen van de receptor_ids die op een gegeven afstand van een andere receptor liggen.
 */
 ...
 * ----------------------------------------
 * Functie voor het bepalen of een receptor id aanwezig is op een bepaald zoomlevel.
 */
 ...
 * -----------------------------------------
 * Functie voor het bepalen van de coordinaten bij een gegeven receptor_id.
 */
 ...
 * -----------------------------------------------------------------------
 * Functie voor het bepalen van de radius en nr op deze radius van een receptor tov een andere receptor.
 */
