-- Road data 
BEGIN; SELECT setup.ae_load_table('road_categories', '{data_folder}/UK/public/road_categories_20161025.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('road_speed_profiles', '{data_folder}/UK/public/road_speed_profiles_20161025.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('road_category_emission_factors', '{data_folder}/UK/public/road_category_emission_factors_20161025.txt'); COMMIT;

-- Farm animal category and -lodging data 
BEGIN; SELECT setup.ae_load_table('farm_animal_categories', '{data_folder}/UK/public/farm_animal_categories_20161107.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('farm_lodging_types', '{data_folder}/UK/public/farm_lodging_types_20161107.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('farm_lodging_type_emission_factors', '{data_folder}/UK/public/farm_lodging_type_emission_factors_20161107.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('farm_reductive_lodging_systems', '{data_folder}/UK/public/farm_reductive_lodging_systems_20161107.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('farm_reductive_lodging_system_reduction_factors', '{data_folder}/UK/public/farm_reductive_lodging_system_reduction_factors_20161107.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('farm_lodging_types_to_reductive_lodging_systems', '{data_folder}/UK/public/farm_lodging_types_to_reductive_lodging_systems_20161107.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('shipping_inland_category_source_characteristics', '{data_folder}/temp/temp_shipping_inland_category_source_characteristics_20160301.txt'); COMMIT;
