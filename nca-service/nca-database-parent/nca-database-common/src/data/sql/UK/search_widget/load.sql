BEGIN; SELECT setup.ae_load_table('municipality_areas', '{data_folder}/UK/public/municipality_areas_20161104.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('town_areas', '{data_folder}/UK/public/town_areas_20161104.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('assessment_areas_to_municipality_areas', '{data_folder}/UK/public/assessment_areas_to_municipality_areas_20161104.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('assessment_areas_to_town_areas', '{data_folder}/UK/public/assessment_areas_to_town_areas_20161104.txt'); COMMIT;
--BEGIN; SELECT setup.ae_load_table('assessment_areas_to_zip_code_areas', '{data_folder}/public/assessment_areas_to_zip_code_areas_20160713.txt'); COMMIT;
